...
{    
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        (    0,     uint256("0x1999fe4151165d561687d0ee36cf57729d403aae4513dd33a148554d7c3e9424"))
        ;
    static const CCheckpointData data = {
        &mapCheckpoints,
        1396163282, // * UNIX timestamp of last checkpoint block
        132765,     // * total number of transactions between genesis and last checkpoint
