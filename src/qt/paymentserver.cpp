...
const QString BITCOIN_IPC_PREFIX("worldcupcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click worldcupcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start worldcupcoin: click-to-pay handler");
    else
...
{
    // clicking on worldcupcoin: URLs creates FileOpen events on the Mac:
